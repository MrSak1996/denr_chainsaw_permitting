      ...
      <div class="box">
        ...
        <div class="mt-10 space-y-6">
          ...
          <div v-if="currentStep === 3" class="space-y-6">
            <Fieldset legend="Payment of Application Fee">
              <div class="relative">
                ...
                <div class="mb-6 flex items-start gap-2 rounded-lg bg-blue-50 p-4 text-sm text-blue-700">
                  <ShieldAlert class="mt-1 h-5 w-5 text-blue-600" />
                  <span> Please complete all fields to proceed with your application for a Permit to Purchase Chainsaw.
                  </span>
                </div>
          ...
          <div class="flex justify-between pt-6">
            ...
            <Button v-if="currentStep === 4" class="ml-auto"> Submit Application </Button>
          </div>
        </div>
      </div>
    </div>
