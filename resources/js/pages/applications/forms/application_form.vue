    ...
    <div class="mt-10 space-y-6">
        ...
        <div v-if="currentStep === 1" class="space-y-4">
            <Fieldset legend="Chainsaw Application">
                ...
                <div class="mb-6 grid gap-6 md:grid-cols-3">
                    <div>
                        <FloatLabel>
                            <InputText id="application_no" v-model="individual_form.application_no" class="w-full font-bold" :disabled="true" />
                    ...
                    <div>
                        <FloatLabel>
                            <Select
                                ...
                                v-model="individual_form.type_of_transaction"
                                :options="['G2C', 'G2B', 'G2G']"
                                class="w-full"
                            />
                ...
                <div class="grid gap-6 md:grid-cols-3">
                    ...
                    <div>
                        <FloatLabel>
                            <Select id="sex" v-model="individual_form.sex" :options="['Male', 'Female', 'Prefer not to say']" class="w-full" />
                ...
                <div class="grid gap-6 md:grid-cols-4">
                    ...
                    <div>
                        <FloatLabel>
                            <Select
                                filter
                                v-model="individual_form.i_province"
                                optionValue="id"
                                :options="prov_name"
                                optionLabel="name"
                    ...
                    <div>
                        <FloatLabel>
                            <Select
                                filter
                                v-model="individual_form.i_city_mun"
                    ...
                    <div>
                        <FloatLabel>
                            <Select
                                filter
                                v-model="individual_form.i_barangay"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <Textarea
                            id="address"
                            v-model="individual_form.i_complete_address"
                            rows="6"
        ...
        <div v-if="currentStep === 2" class="space-y-6">
            <Fieldset legend="Chainsaw Information">
                ...
                <div
                    v-for="(chainsaw, index) in chainsaws"
                    :key="index"
                ...
                >
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        <div>
                            <FloatLabel>
                                <Select v-model="chainsaw.type" :options="['Gasoline', 'Electric', 'Battery Operated']" class="w-full" />
        ...
        <div class="flex justify-between pt-6">
            ...
            <Button v-if="currentStep < 3" class="ml-auto flex items-center justify-center gap-2" @click="nextStep" :disabled="isLoading">
