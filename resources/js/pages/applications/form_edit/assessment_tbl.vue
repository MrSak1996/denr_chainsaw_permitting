        ...
        <table class="min-w-full border border-gray-300 rounded-lg bg-white">
          ...
          <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-3 py-2 border">
                            <textarea v-model="onsite.findings" class="form-control w-full" rows="3" placeholder="Enter findings..."></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="px-3 py-2 border font-medium">Recommendations</td>
                        <td class="px-3 py-2 border">
                            <textarea v-model="onsite.recommendations" class="form-control w-full" rows="3" placeholder="Enter recommendations..."></textarea>
                        </td>
                    </tr>
                </tbody>
        </table>
