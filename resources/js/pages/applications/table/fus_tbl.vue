...
const applicantsTable = async () => {
    try {
        const { applications: endorsedApplications, count: endorsedCount } = await ProductService.getApplicationsByStatus(11);
            ...
            <div class="mb-4 flex border-b border-gray-200">
                ...
                >
                    ...
                    <div class="relative inline-block">
                        <OverlayBadge v-if="totalCount > 0" :value="totalCount" severity="danger" size="small" class="absolute top-0 right-0" />
                ...
                <div v-if="activeTab === 're'" class="space-y-2 text-sm text-gray-700">
                    <div class="h-auto w-full">
                        ...
                        >
                                ...
                                <template #body="slotProps">
                                    <div class="flex space-x-2">
                                        <div class="mt-2 flex gap-2">
                                            ...
                                            <Button
                                                :disabled="slotProps.data.is_fus_received != 1"
                            ...
                            <Column field="application_no" header="Application No" sortable style="text-align: center; width: 10rem">
                                <template #body="{ data }">
